    ...
    <>
      <div style={{ backgroundColor: "#f8f9fa" }}>
        ...
        <section
          ...
          style={{
            backgroundImage: 'url("https://angel-frontend.s3.ap-southeast-1.amazonaws.com/public/images/global-hero.jpg")',
              ...
              <div className="col-md-6 col-lg-4">
                ...
                >
                  <div className="card border-0 shadow-sm h-100">
                    ...
                    >
                      <Image
                        src="https://angel-frontend.s3.ap-southeast-1.amazonaws.com/public/images/corporate/india.jpg"
                        alt="India"
                        width={400}
                        height={180}
                      ...
                      <div className="position-absolute bottom-0 start-0 p-3 bg-dark bg-opacity-50 w-100">
                        <div className="d-flex align-items-center">
                          <Image
                            src="https://angel-frontend.s3.ap-southeast-1.amazonaws.com/public/images/flags/india.svg"
                            alt="flag"
                            width={28}
                            height={20}
                            className="me-2"
